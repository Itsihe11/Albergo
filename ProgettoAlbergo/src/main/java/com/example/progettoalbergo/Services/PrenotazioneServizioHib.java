...
public class PrenotazioneServizioHib {
	...
	public List<PrenotazioneServizi> getAllServizi() {
		return servizioRepository.findAll();
	}
	
	
	public void addServizio(PrenotazioneServizi nuovoServizio) {
	...
	public Optional<PrenotazioneServizi> modificaServizio(Long id, Servizio servizioDettagli) {
